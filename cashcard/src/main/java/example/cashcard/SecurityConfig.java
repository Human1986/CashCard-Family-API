...
public class SecurityConfig {
    ...
    /**
     * This UserDetailsService configuration should be understandable:
     * configure a user named sarah1 with password abc123.
     * <p>
     * Spring's IoC container will find the UserDetailsService Bean and Spring Data will use it
     * when needed.
     */
    @Bean
